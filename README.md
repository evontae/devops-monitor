...
This project focuses on building a robust and scalable system monitoring tool, deeply rooted in SRE/DevOps principles. Leveraging containerization (Docker), orchestration (Kubernetes/Helm), and cloud-native technologies on Azure (Functions, Monitor, Container Registry, Log Analytics, DevOps, Chaos Studio), the tool is designed to provide comprehensive insights into system health and performance while prioritizing reliability, automation, continuous improvement, and proactive incident response.
...
*   **Deliverable 1.1: Modularized System Monitor with Logging and Tests**
    ...
    *   Break down system\_monitor.py into modules (cpu, memory, disk, network) with clear functions and interfaces.
